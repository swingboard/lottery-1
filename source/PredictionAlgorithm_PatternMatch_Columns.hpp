#ifndef LOTTERY_PREDICTIONALGORITHM_PATTERNMATCH_COLUMNS_HPP
#define LOTTERY_PREDICTIONALGORITHM_PATTERNMATCH_COLUMNS_HPP
...
namespace lottery
{
    ...
    /**
        A prediction algorithm that does pattern matching on columns.
        It selects the next number from the pattern that matches the most the end of the sequence of draws.
     */
    class PredictionAlgorithm_PatternMatch_Columns : public PredictionAlgorithm
    {
    public:
        /**
            Constructor.
         ...
         */
        PredictionAlgorithm_PatternMatch_Columns(size_t patternSize, int valueEpsilon, int patternEpsilon);
...
#endif //LOTTERY_PREDICTIONALGORITHM_PATTERNMATCHCOLUMNS_HPP
